...
export default function CandidatesPage() {
  return (
    <div className="marketing-page candidates-page">
      ...
      <Section>
        <div className="shell-card u-glass u-shadow-soft candidates-daily">
      ...
      <Section>
        <div className="shell-card u-glass u-shadow-soft candidates-bookings">
      ...
      <Section>
        <div className="shell-card u-glass u-shadow-soft candidates-rewards">
