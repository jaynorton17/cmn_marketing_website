...
?>
<section class="cmn-section cmn-schools-faq" aria-labelledby="cmn-schools-faq-title">
	<div class="cmn-container cmn-stack">
		<div class="cmn-stack cmn-schools-heading">
			<p class="cmn-eyebrow">Schools FAQ</p>
			<h2 id="cmn-schools-faq-title" class="cmn-h2">Common questions from school operations teams.</h2>
		</div>
		...
		<div class="cmn-panel cmn-faq">
			<?php foreach ($faq_groups as $group_index => $group) : ?>
				...
				$group_heading_id = 'cmn-schools-faq-group-' . ($group_index + 1);
				?>
